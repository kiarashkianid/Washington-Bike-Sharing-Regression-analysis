...
- **Kiarash Kianidehkordi**:  data description, compiling the dataset used in this paper
- **Min Ji Koo**:  introduction, data description
- **Joyce Lin**:  introduction, preliminary analysis, editing the proposal

---

# Introduction

Motor transportation accounts for a staggering 20% of greenhouse gas emissions in the U.S. (Agency, 2005; Gotschi & Mills, 2008), pushing the need for sustainable solutions like bike-sharing systems to the forefront. These modern bike-sharing programs automate membership, rentals, and returns, integrating seamlessly into urban transportation networks. This integration is widely recognized as a sustainable strategy to reduce CO2 emissions, alleviate traffic congestion, and promote healthier communities by addressing public health concerns such as obesity and diabetes (Bajracharya et al., 2018; Cai et al., 2019; Lumsdon & Tolley, 2001; Zhang et al., 2015; Shaheen et al., 2013).

While bike-sharing contributes significantly to environmental and health benefits, it must also adapt to the unique demand patterns of the specific city that they are installed in.  While Bikeshare usage does vary on an hourly basis, it is more broadly influenced by factors such as seasonality and weather.  Numerous studies have demonstrated a strong correlation between climate conditions and bike-sharing usage (Fournier, Christofa, and Knodler, 2017; Wadud, 2014;  Beigi et al., 2022). Seasonal fluctuations—particularly a sharp decline during the winter months—have led many bike-sharing programs, such as Great Rides, Capital Bikeshare, and Boulder B-cycle, to temporarily suspend operations due to significantly lower trip generation (Godavarthy & Taleqani, 2017).  Thus, environmental and logistical factors are common metrics that researchers look at to determine the optimal allocation of bikes.

Our analysis focuses on Washington DC's Capital Bikeshare (referred to as Bikeshare in this paper) data in 2011 with a focus on peak hours (5-6 PM and 8 AM).  This paper ultimately seeks to determine **whether reducing operations to reflect seasonal demand changes is reasonable for Bikeshare, as supported by the broader evidence on climate impacts and bikeshare usage.**

Note that while this dataset has time series elements, the research question asks for the effect of *winter specifically* on Bikeshare usage.  Thus, I believe a linear regression is still appropriate with this research question, as the analysis will be focusing on the effect of winter = 1 versus winter = 0.
