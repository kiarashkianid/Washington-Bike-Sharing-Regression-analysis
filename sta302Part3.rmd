...
initialFitted <-lm (cnt ~ temp +  windspeed + hum + I(season == 1) + I(workingday == 1), data = hourData)
...
```{R}
transformedFitted <- lm (cnt ~ temp + windspeed  + (I(hum^2)) + I(season == 1) + I(workingday == 1), data = hourData)
...
transformedFitted2 <- lm (log(cnt) ~ temp+ windspeed  + I(hum^2) + I(season == 1) + I(workingday == 1), data = hourData)
...
transformedFitted3 <- lm (sqrt(cnt) ~ temp+ windspeed  + I(hum^2) + I(season == 1) + I(workingday == 1), data = hourData)
...
plot( (hourData$windspeed) , transformedFitted3$residuals,
     ...
     col = "lightblue",
     pch = 19)
transformedFitted4 <- lm (sqrt(cnt) ~ temp+ log(windspeed+1)  + log(I(hum^2))  + I(season == 1) + I(workingday == 1), data = hourData)
...
transformedFitted5 <- lm (cnt ~ temp+ log(windspeed+1)  + log(hum^2) + I(season == 1) + I(workingday == 1), data = hourData)
